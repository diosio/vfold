...
import vfold.utility.PoolingUtility;
import vfold.display.text.TextSimple;
import vfold.utility.ColorUtility;
import flash.display.DisplayObject;
...
class TableRow extends Button{
    ...
    // Object Pool
    private var op:PoolingUtility=new PoolingUtility(TextSimple);
    // Text Format
...
class TableContent extends Sprite{
    ...
    // List Row Pool
    private var lrp:PoolingUtility=new PoolingUtility(TableRow);
    // List Row Map Vector
    private var lrm:Vector.<TableRow>;
    // Column Pool
    private var clp:PoolingUtility=new PoolingUtility(TableColumn);
    // Row Container
