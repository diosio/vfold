...
public class Folder extends CoreView{
    ...
    public function Folder(defaultView:FolderView,defaultLayout:FolderLayout,index:uint) {
    ...
    public function get applicationHeight():Number {return super.height+GAP}
